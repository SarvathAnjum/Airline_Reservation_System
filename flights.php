                                ...
                                <form id="manage-filter"  action="index.php?page=flights" method="POST">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="date" class="form-control input-sm datetimepicker2" name="date" autocomplete="off" value="<?php echo isset($date) && !empty($date) ? date("d-m-Y",strtotime($date)) : "" ?>">
                                        </div>
	...
	<section class="page-section" id="flight" >
        <div class="container">
        	<div class="card">
				...
				$where = " where date(f.departure_datetime) > '".date("d-m-Y")."' ";
				if($_SERVER['REQUEST_METHOD'] == "POST" )
